    ...
    <div id='content'>
        ...
        <form method='POST' action='/update/{{ $movie->id }}' name="updateMovie" class="form"> 
            ...
            <div id="watchedCheckbox">    
                <label id="watchedBox"><input type='checkbox' name='watched' id="watched" value='1' {{ $movie->watched == '1' ? 'CHECKED' : '' }} /> Watched?</label>
            </div><br>
            ...
            <div id="movieRating">
                ...
                <div class="ratingRadios">
                    <label><input type="radio" class="movieRating" name="rating" value="1" 
                        {{ old('rating') == '1' ? 'CHECKED' : '' }}>1 <i class="fa fa-star" aria-hidden="true"></i></label>
                    <label><input type="radio" class="movieRating" name="rating" value="2" 
                        {{ old('rating') == '2' ? 'CHECKED' : '' }}>2 <i class="fa fa-star" aria-hidden="true"></i></label> 
                    <label><input type="radio" class="movieRating" name="rating" value="3" 
                        {{ old('rating') == '3' ? 'CHECKED' : '' }}>3 <i class="fa fa-star" aria-hidden="true"></i></label> 
                    <label><input type="radio" class="movieRating" name="rating" value="4" 
                        {{ old('rating') == '4' ? 'CHECKED' : '' }}>4 <i class="fa fa-star" aria-hidden="true"></i></label> 
                    <label><input type="radio" class="movieRating" name="rating" value="5" 
                        {{ old('rating') == '5' ? 'CHECKED' : '' }}>5 <i class="fa fa-star" aria-hidden="true"></i></label>      
                </div>
            </div><br>  
